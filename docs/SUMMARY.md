...
* [File Access Setup](getting-started/file-access.md)
...
* [Reading Mode](features/reading-mode.md)
...
* [Technical Documentation](use-cases/technical-docs.md)
* [Academic Papers](use-cases/academic-papers.md)
* [Business Reports](use-cases/business-reports.md)
