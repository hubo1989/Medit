...
**Rašykite Markdown formatu, eksportuokite į tobulą Word vienu paspaudimu.**

*Visiškai nemokama · Vietinis apdorojimas · 18+ profesionalių temų · 28 kalbų palaikymas*
...
```mermaid
graph TB
    A[Vartotojas] --> B[Apkrovos balansatorius]
    B --> C[Serveris 1]
    B --> D[Serveris 2]
```
``````
