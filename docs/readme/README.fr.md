...
**Écrivez en Markdown, exportez vers Word parfait en un clic.**

*Entièrement gratuit · Traitement local · 18+ thèmes professionnels · 23 langues*
...
```mermaid
graph TB
    A[Utilisateur] --> B[Équilibreur de Charge]
    B --> C[Serveur 1]
    B --> D[Serveur 2]
```
``````
...
### 23 Langues d'Interface

Chinois simplifié · Chinois traditionnel · English · Deutsch · Español · Français · Italiano · Nederlands · Português (BR) · Português (PT) · Polski · Русский · 日本語 · 한국어 · ไทย · Tiếng Việt · हिन्दी · Bahasa Indonesia · Dansk · Suomi · Norsk · Svenska · Türkçe
