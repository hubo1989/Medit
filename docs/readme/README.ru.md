...
*Полностью бесплатно · Локальная обработка · 18+ профессиональных тем · Поддержка 23 языков*
...
**Диаграммы Mermaid** · **Graphviz DOT** · **Диаграммы данных Vega/Vega-Lite** · **Infographic** · Изображения SVG · Сложные HTML-таблицы
...
**Graphviz DOT:** Ориентированные/неориентированные графы, топология сети, автоматы состояний → Системная архитектура, анализ зависимостей  
...
- 🇨🇳 Songti / Heiti / Mixed → Китайские документы
- 🎨 Typewriter / Sakura → Творческий контент
...
Заголовки · Абзацы · Жирный · Курсив · Зачёркнутый · Списки · Списки задач · Цитаты · Блоки кода (подсветка 100+ языков) · Таблицы · Ссылки · Изображения · Диаграммы Mermaid · Диаграммы Vega / Vega-Lite · Диаграммы Infographic · Формулы LaTeX · HTML · Расширения GFM

### 18 тем

**Бизнес:** Default · Business · Technical  
**Академические:** Academic  
**С засечками:** Palatino · Garamond · Cambria · Elegant  
**Без засечек:** Verdana · Trebuchet · Century  
**Китайские:** Songti · Heiti · Mixed  
**Творческие:** Typewriter · Sakura · Water · Minimal
...
О: Все диаграммы Mermaid (блок-схема, последовательность, Гантт, класс, состояние, круговая, ER и т.д.), диаграммы визуализации данных Vega / Vega-Lite, статистические диаграммы Infographic + автоконвертация SVG.
...
О: В настоящее время 18 предустановленных тем, настройка скоро появится.
...
О: Бизнес-отчёты → Business · Научные статьи → Academic · Техническая документация → Technical · Китайские документы → Songti/Mixed
...
📖 [Полная документация](https://github.com/xicilion/markdown-viewer-extension) · 🐛 [Сообщить о проблеме](https://github.com/xicilion/markdown-viewer-extension/issues) · 💡 [Запрос функции](https://github.com/xicilion/markdown-viewer-extension/issues) · ⭐ [Поддержка GitHub](https://github.com/xicilion/markdown-viewer-extension)
...
**Вы получите:** Markdown → Word конвертация одним кликом · Автоконвертация Mermaid · Редактируемые формулы LaTeX · Подсветка кода 100+ языков · 18+ тем · Умный кэш · Полностью бесплатно
...
**URL проекта:** https://github.com/xicilion/markdown-viewer-extension
