...
**Markdown para Word perfeito com um clique — Mermaid, Graphviz, Vega, infografia, LaTeX (editável), realce de código, processamento local**
...
```mermaid
graph TB
    A[Utilizador] --> B[Balanceador de carga]
    B --> C[Servidor1]
    B --> D[Servidor2]
```
``````
...
R: Relatórios empresariais → Business · Artigos académicos → Academic · Documentação técnica → Technical · Documentos chineses → 宋体/混排
...
📖 [Documentação completa](https://github.com/markdown-viewer/markdown-viewer-extension) · 🐛 [Relatar problema](https://github.com/markdown-viewer/markdown-viewer-extension/issues) · 💡 [Sugerir funcionalidade](https://github.com/markdown-viewer/markdown-viewer-extension/issues) · ⭐ [Suporte no GitHub](https://github.com/markdown-viewer/markdown-viewer-extension)
...
3. Clique em「Gerir extensões」, ative「Permitir acesso a URLs de ficheiros」
4. Arraste ficheiro `.md` para o navegador
5. ✅ Comece a usar

**Obterá:** Conversão Markdown → Word com um clique · Conversão automática de Mermaid em imagens · Fórmulas LaTeX editáveis · Destaque de código 100+ linguagens · 29+ temas · Cache inteligente · Totalmente gratuito
